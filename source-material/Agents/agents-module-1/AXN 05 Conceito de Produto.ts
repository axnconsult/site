...
export const runWorkflow = async (workflow: WorkflowInput) => {
  return await withTrace("AXN | 05 Conceito de Produto", async () => {
    const state = {
    ...
    const runner = new Runner({
      traceMetadata: {
        ...
        workflow_id: "wf_6a1494ae4ecc819085555e25109efa1d0010890d34eb9ea3"
      }
    });
    ...
    const axn05ConceitoDeProdutoResult = {
      output_text: axn05ConceitoDeProdutoResultTemp.finalOutput ?? ""
    };
  });
}
